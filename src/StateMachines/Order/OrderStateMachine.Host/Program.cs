...
using OrderStateMachine.Host;
using OrderStateMachine.Host.Settings;
...
Host.CreateDefaultBuilder(args)
    ...
    .ConfigureServices((hostContext, services) =>
    {
        ...
        {
            x.AddSagaStateMachine<OrderStateMachineInstance, OrderStateInstance>().MongoDbRepository(r =>
            {
